...
public class LogUtils {
    ...
    private static final String LOG_EXTERNAL_REQUEST_ID_KEY = "external_request_id";
    ...
    private static final String LOG_MSG_TYPE_KEY = "message_type";
    ...
    public static void logEnabledMDC(String message, MessageType messageType, MessageDirection messageDirection, String externalRequestId, String contentType, String protocol, Map<String,Object> protocolMetadata, String driverRequestId){
        try {
            ...
            try {
                ...
                throw new SdwanResponseException("Error in parsing protocol_metadata " + protocolMetadata, e);
            }
            MDC.put(LOG_MSG_TYPE_KEY, messageType.toString());
            MDC.put(LOG_DRIVER_REQUEST_ID, driverRequestId);
            if (message.contains("password ")) {
                logger.info(message.replaceAll("password..*?!", "password  *********"));
