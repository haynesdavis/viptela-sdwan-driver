...
import com.ibm.sdwan.viptela.model.web.ErrorInfo;
import com.ibm.sdwan.viptela.security.AuthenticationException;
...
/**
 * Handles the conversion of Exceptions thrown by Viptela Sdwan Rest API calls
 */
@RestControllerAdvice
public class SdwanExceptionHandlingControllerAdvice {

    private static final Logger logger = LoggerFactory.getLogger(SdwanExceptionHandlingControllerAdvice.class);

    @ExceptionHandler(AuthenticationException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    protected ErrorInfo handleAuthenticationException(HttpServletRequest req, AuthenticationException cause) {
        return defaultHandle("Authentication failed", req, cause);
    }

    @ExceptionHandler(TemplateException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    protected ErrorInfo handleTemplateException(HttpServletRequest req, TemplateException cause) {
        return defaultHandle("Error in payload template", req, cause);
    }
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    protected ErrorInfo handleHttpClientErrorException(HttpServletRequest req, HttpClientErrorException cause) {
        return defaultHandle(cause.getLocalizedMessage(), req, cause);
    }
    ...
    @ExceptionHandler(SdwanResponseException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ResponseBody
    protected ErrorInfo handleSdwanResponseException(HttpServletRequest req, SdwanResponseException cause) {
